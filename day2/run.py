...
<html>
    ...
    <body>
        <div class="content">
            <img src="http://fs5.directupload.net/images/151201/aqg536gd.jpg" alt="day2" />
            <h1>HAPPY 2ND DECEMBER!</h2>
        </div>
    </body>
</html>"""
...
if __name__ == '__main__':
    ...
    reactor.listenTCP(2, site)
    reactor.listenTCP(2, site, interface='fcff:17:40::13')
    reactor.run()
